...
def evaluate(
    ...
    version_model: Literal['ori','v0','v1','v2','v3','v4','v5'],
    ...
    if version_model == 'v0' or version_model == 'ori':
        ...
        dir_name_list= [['c_to_hrt','c_to_hr','c_to_tr','sc_to_hr','sc_to_tr']]
    elif version_model == 'v2':
        dir_name_list= [['c_to_hrt','c_to_hr','c_to_tr'],['c_to_hrt','sc_to_hr','sc_to_tr']]
    elif version_model == 'v3':
        dir_name_list= [['c_to_hrt','c_to_hr'],['c_to_hrt','c_to_tr'],['c_to_hrt','sc_to_hr'],['c_to_hrt','sc_to_tr']]
    elif version_model == 'v4':
        dir_name_list= [['c_to_hrt','c_to_hr'],['c_to_hrt','c_to_tr'],['sc_to_hr'],['sc_to_tr']]
    elif version_model == 'v5':
        dir_name_list= [['c_to_hrt','c_to_hr'],['c_to_hrt','c_to_tr'],['sc_to_tr'],['sc_to_hr']]
    ...
    for model_index,model_name_or_path in enumerate(model_name_or_path_list):
        ...
        for (read_dir_name,file_type,file),out_dir in zip(files[model_index],outs[model_index]):
            ...
            if 'sc_to_hr' in read_dir_name or 'sc_to_tr' in read_dir_name:
                # 需要后处理的数据
            ...
            for s_index,sample in enumerate(predict_datas):
                if 'Baichuan2-7B-Chat' in model_name_or_path:
