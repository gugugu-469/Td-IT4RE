...
deepspeed --include localhost:2 --master_port=10722 src/train.py --deepspeed ./ds_config.json \
    ...
    --lora_rank 16 \
    --lora_alpha 32 \
    --dataset ADE_c_to_hrt_withtype,ADE_c_to_hr_withtype,ADE_sc_to_hr_withtype \
    --template deepseek \
    --finetuning_type lora \
    --output_dir ../../trained_models/RE_SFT_0104/4_model_1_withtype/ade_deepseek_all_lora_${now_time} \
    --overwrite_cache \
