...
deepspeed --include localhost:2 --master_port=10722 src/train.py --deepspeed ./ds_config.json \
    ...
    --lora_rank 16 \
    --lora_alpha 32 \
    --dataset CMeIE_c_to_hrt,CMeIE_c_to_ht,CMeIE_rc_to_ht \
    --template baichuan2 \
    --finetuning_type lora \
    --output_dir ../../trained_models/RE_SFT_0104/4_model_1_notype/CMeIE_baichuan2_all_lora_${now_time} \
    --overwrite_cache \
...
# ps -ef | grep 负能力训练 | awk '{print $2}' | tr '\n' ' '