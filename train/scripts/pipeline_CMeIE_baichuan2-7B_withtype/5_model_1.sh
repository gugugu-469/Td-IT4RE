...
deepspeed --include localhost:2 --master_port=10722 src/train.py --deepspeed ./ds_config.json \
    ...
    --lora_rank 16 \
    --lora_alpha 32 \
    --dataset CMeIE_c_to_hrt_withtype,CMeIE_c_to_ht_withtype,CMeIE_htc_to_r_withtype \
    --template baichuan2 \
    --finetuning_type lora \
    --output_dir ../../trained_models/RE_SFT_0104/5_model_1_withtype/CMeIE_baichuan2_all_lora_${now_time} \
    --overwrite_cache \
